...
namespace Exo.WebApi.Controllers
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        public UsuariosController(UsuarioRepository _usuarioRepository)
        {
        ...
        public IActionResult Post(Usuario usuario)
        {
            ...
            // Gera o token.
            var token = new JwtSecurityToken(issuer: "exoapi.webapi",
            // Emissor do token.
            ...
            // Tempo de expiração. signingCredentials: creds 
